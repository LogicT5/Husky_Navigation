...
public:
    ...
    void HandleMesh(const sensor_msgs::PointCloud2 & vLaserData);
    void HandleMesh2(const visualization_msgs::Marker & oMeshData);
...
private:
   ...
   ros::Publisher m_oMeshPublisher;
    ...
    #ifdef DEBUG
    ros::Publisher debugSubPointCloud;
    #endif

    // 载体系与雷达系不同时，进行坐标变换
    std::string OdomFrame;
    std::string BaselinkOdomFrame;
    tf::TransformListener tfListener;
    tf::StampedTransform Odom2BaselinkOdom;
    Eigen::Matrix4d Odom2BaselinkOdomTF;
